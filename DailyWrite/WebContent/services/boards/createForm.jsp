		...
		<div class="total-area">
			<div class="form-box">
				...
				<form method="POST" action="create.jsp">
					...
					<input class="normal-button-2" type="submit" value="글 작성">
					<div class="normal-button-2"><a href="list.jsp"><p class="normal-button-2-text">목록으로 가기</p></a></div>
				</form>
